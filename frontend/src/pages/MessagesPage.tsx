            ...
            <div className="w-full max-w-7xl grid grid-cols-1 md: grid-cols-[80px_1fr] lg:grid-cols-[260px_1fr] px-4 gap-6 relative z-10">
                ...
                <aside className="hidden md:flex flex-col justify-between py-6  border-r border-slate-900/60 pr-4">
                    <div className="space-y-8">
                        <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-tr from-violet-600 to-indigo-600 shadow-lg lg:mx-0 mx-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <button onClick={logout} className="flex items-center gap-4 w-full p-3 rounded-xl text-rose-400 hover:bg-rose-950/20 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]">
                            <LogOut size={22} />
