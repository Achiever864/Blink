...
import { Briefcase, FileText, MapPin, Globe, Link as LinkIcon, Heart, ChevronLeft, ChevronRight, X } from "lucide-react";
            ...
            >
                ...
                <div className="mb-8">
                    ...
                    <div className="h-1.5 w-full rounded-full bg-brand-bg-secondary/70 overflow-hidden">
                        <div
                            className="h-1.5 w-full rounded-full bg-brand-bg-secondary/70 overflow-hidden"
                        >
                            <div
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative flex items-center">
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-2xl border border-brand-border bg-brand-bg-secondary/70 py-3.5 pl-12 pr-4 text-brand-text placeholder:text-brand-text-muted outline-none focus:border-brand-accent focus:ring-2 focus:ring-brand-accent/30"
                            ...
                            <div className="space-y-6 animate-slideIn">
                                <div>
                                    ...
                                    <p className="text-sm text-brand-text-muted mt-1">
                                        Share your location to find local connection
                                    </p>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative flex items-center">
                                            <Globe className="absolute left-4 text-brand-text-muted" />
                                            <input
                                                type="text"
                                            ...
                                            {PRESET_INTERESTS.map((interest) => {
                                                ...
                                                return(
                                                    <button
                                                        key={interest}
                                                        type="button"
                                                        onClick={`rounded-full px-4 py-1.5 text-xs font-semibold transition-all duration-300 border ${
                                                            isSelected
                        ...
                        <div className="mt-8 flex items-center justify-between gap-4">
                            {currentStep > 1 ? (
                                ...
                                <button
                                    type="button"
                                    onClick={()=> handleFinish(true)}
                                    className="text-sm font-semibold text-brand-text-muted hover:text-brand-text transiton"
                                >
                                    Skip all steps
                                </button>
                            )}
